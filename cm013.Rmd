...
- **do not know** this information simply states the average number of hours, which could be due to legislature, specific job specifications, etc.

- Main takeaway: Cannot determine `motivation` from a graph telling number of hours.
...
- **Don't Know** However, it is unclear the range of time, and the y-axis is far too large to appreciably see any difference. 

- Main takeaway: Scientific methodology is required to interpret graphs
...
- **Very weak** The y-axis is upside down, so actually there is an increase in shootings.

- Main takeaway: Axis are important, it is incredibly easy to decieve people with incorrect plotting
...
#how to creat plotly to online account?
