...
#NOTES:
#geom_histogram, geom_density, geom_jitter
#geom_density_ridges -> density dist in diff cont 

#geompath will connect line in order of rows, line will go form L2R
```
...
ggplot(gapminder, aes(gdpPercap, lifeExp)) +
  ...
  facet_wrap(~ continent, nrow=1)#, scales = "free" free_x/y frees only one axis)
```
...
gapminder %>% 
  ...
  ggplot(aes(gdpPercap, lifeExp, size = pop, colour =
               continent)) +
